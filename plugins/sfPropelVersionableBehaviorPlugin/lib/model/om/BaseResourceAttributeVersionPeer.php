...
abstract class BaseResourceAttributeVersionPeer {
    ...
    foreach (sfMixer::getCallables('BaseResourceAttributeVersionPeer:doSelectRS:doSelectRS') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseResourceAttributeVersionPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseResourceAttributeVersionPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseResourceAttributeVersionPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseResourceAttributeVersionPeer', $c, $con);
    }
