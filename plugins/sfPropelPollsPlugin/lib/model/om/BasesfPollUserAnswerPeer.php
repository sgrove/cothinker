...
abstract class BasesfPollUserAnswerPeer {
    ...
    foreach (sfMixer::getCallables('BasesfPollUserAnswerPeer:doSelectRS:doSelectRS') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BasesfPollUserAnswerPeer:doSelectJoin:doSelectJoin') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BasesfPollUserAnswerPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BasesfPollUserAnswerPeer', $c, $con);
    }
