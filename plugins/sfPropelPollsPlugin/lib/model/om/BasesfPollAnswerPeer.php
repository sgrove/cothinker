...
abstract class BasesfPollAnswerPeer {
    ...
    foreach (sfMixer::getCallables('BasesfPollAnswerPeer:doSelectRS:doSelectRS') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BasesfPollAnswerPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BasesfPollAnswerPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BasesfPollAnswerPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BasesfPollAnswerPeer', $c, $con);
    }
