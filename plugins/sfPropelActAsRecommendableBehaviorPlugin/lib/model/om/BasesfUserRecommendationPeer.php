...
abstract class BasesfUserRecommendationPeer {
    ...
    foreach (sfMixer::getCallables('BasesfUserRecommendationPeer:doSelectRS:doSelectRS') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BasesfUserRecommendationPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BasesfUserRecommendationPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BasesfUserRecommendationPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BasesfUserRecommendationPeer', $c, $con);
    }
