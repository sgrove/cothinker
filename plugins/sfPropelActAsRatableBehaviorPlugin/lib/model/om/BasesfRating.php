...
abstract class BasesfRating extends BaseObject  implements Persistent {
	...
	public function setComment($v)
	{
		...
		if ($this->comment !== $v) {
			$this->comment = $v;
			$this->modifiedColumns[] = sfRatingPeer::COMMENT;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = sfRatingPeer::STATUS;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfRatingPeer::COMMENT)) $criteria->add(sfRatingPeer::COMMENT, $this->comment);
		if ($this->isColumnModified(sfRatingPeer::STATUS)) $criteria->add(sfRatingPeer::STATUS, $this->status);
