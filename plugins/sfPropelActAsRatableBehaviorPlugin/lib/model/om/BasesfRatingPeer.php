...
abstract class BasesfRatingPeer {
	...
	const COMMENT = 'sf_ratings.COMMENT';

	
	const STATUS = 'sf_ratings.STATUS';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'RatableModel', 'RatableId', 'UserId', 'Rating', 'Comment', 'Status', ),
		BasePeer::TYPE_COLNAME => array (sfRatingPeer::ID, sfRatingPeer::RATABLE_MODEL, sfRatingPeer::RATABLE_ID, sfRatingPeer::USER_ID, sfRatingPeer::RATING, sfRatingPeer::COMMENT, sfRatingPeer::STATUS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'ratable_model', 'ratable_id', 'user_id', 'rating', 'comment', 'status', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'RatableModel' => 1, 'RatableId' => 2, 'UserId' => 3, 'Rating' => 4, 'Comment' => 5, 'Status' => 6, ),
		BasePeer::TYPE_COLNAME => array (sfRatingPeer::ID => 0, sfRatingPeer::RATABLE_MODEL => 1, sfRatingPeer::RATABLE_ID => 2, sfRatingPeer::USER_ID => 3, sfRatingPeer::RATING => 4, sfRatingPeer::COMMENT => 5, sfRatingPeer::STATUS => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'ratable_model' => 1, 'ratable_id' => 2, 'user_id' => 3, 'rating' => 4, 'comment' => 5, 'status' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfRatingPeer::COMMENT);

		$criteria->addSelectColumn(sfRatingPeer::STATUS);
    ...
    foreach (sfMixer::getCallables('BasesfRatingPeer:doSelectRS:doSelectRS') as $callable)
    {
