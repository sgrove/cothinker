...
//$tfont[] = 'SCRAWL.ttf';  
//$tfont[] = 'WAVY.ttf';   
$tfont = sfConfig::get('app_cryptographp_fonts', array('luggerbu.ttf'));
...
$noiselinemax = sfConfig::get('app_cryptographp_noise_line_max', 1);     // Bruit: Nb maximum de lignes al�atoires

$nbcirclemin = sfConfig::get('app_cryptographp_nb_circle_min', 1);      // Bruit: Nb minimum de cercles al�atoires 
$nbcirclemax = sfConfig::get('app_cryptographp_nb_circle_max', 1);      // Bruit: Nb maximim de cercles al�atoires
