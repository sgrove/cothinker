    ...
    <fieldset>
      ...
      <?php if (isset($config_used['layout']['title'])): ?>
        <div class="<?php echo $config_used['layout']['title']; ?>">
          ...
          <label for="sf_comment_title"><?php echo ucwords(__('title')) ?></label>
      ...
      <div class="required">
        ...
        <strong><label for="sf_comment"><?php echo __('Leave a comment') ?></label></strong>
    ...
    <?php if ($config['use_ajax']): ?>
      ...
      echo submit_to_remote('sf_comment_ajax_submit',
                           ...
                           array('update'   => array('success' => 'sf_comment_list', 'failure' => 'sf_comment_form'),
                                 ...
                                 'complete' => "Element.hide('sf_comment_ajax_indicator');Element.scrollTo('sf_comment_list');Element.hide('sf_comment_form');",
                                 'script'   => true),
                           array('class' => 'submit'));
      ?>
      </div>
      <noscript>
          <?php echo submit_tag(__('Post comment'), array('class' => 'submit')) ?>
      </noscript>
    <?php else: ?>
      <?php echo submit_tag(__('Post comment without JS'), array('class' => 'btn')) ?>
    <?php endif; ?>
  </form>
<?php endif; ?>