...
abstract class BasenahoWikiWikiPeer {
	...
	const CLASS_DEFAULT = 'plugins.nahoWikiPlugin.lib.model.nahoWikiWiki';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Slug', 'Model', 'ModelId', 'Standalone', 'CreatedAt', ),
		BasePeer::TYPE_COLNAME => array (nahoWikiWikiPeer::ID, nahoWikiWikiPeer::TITLE, nahoWikiWikiPeer::SLUG, nahoWikiWikiPeer::MODEL, nahoWikiWikiPeer::MODEL_ID, nahoWikiWikiPeer::STANDALONE, nahoWikiWikiPeer::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'slug', 'model', 'model_id', 'standalone', 'created_at', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Slug' => 2, 'Model' => 3, 'ModelId' => 4, 'Standalone' => 5, 'CreatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (nahoWikiWikiPeer::ID => 0, nahoWikiWikiPeer::TITLE => 1, nahoWikiWikiPeer::SLUG => 2, nahoWikiWikiPeer::MODEL => 3, nahoWikiWikiPeer::MODEL_ID => 4, nahoWikiWikiPeer::STANDALONE => 5, nahoWikiWikiPeer::CREATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'slug' => 2, 'model' => 3, 'model_id' => 4, 'standalone' => 5, 'created_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	{
		return BasePeer::getMapBuilder('plugins.nahoWikiPlugin.lib.model.map.nahoWikiWikiMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			Propel::registerMapBuilder('plugins.nahoWikiPlugin.lib.model.map.nahoWikiWikiMapBuilder');
}
