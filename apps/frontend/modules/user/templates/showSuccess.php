...
<?php if ($tab == 'editprofile') include_partial('profile_edit', array('profile' => $profile)) ?>
...
<?php if ($tab == 'personalprojects') include_partial('profile_projects', array('profile' => $profile)) ?>
<?php /*
<div>
