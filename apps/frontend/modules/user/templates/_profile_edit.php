...
<div class="form-holder-blue" style="width:35%;">
  ...
  <div class="blue-shadow">
    <?php echo form_tag('user/updateProfile', array('name' => 'profile', 'class' => 'blue',)) ?>
      ...
      <?php echo label_for('gender', 'Gender'), select_tag('gender', options_for_select(array(sfConfig::get('app_profile_male') => 'Gentleman', sfConfig::get('app_profile_female') => 'Lady'), $profile->getGender())) ?><br />
      ...
      <hr />
      <?php if ($sf_request->hasError('profile_password')) { echo '<span class="form-error">'.$sf_request->getError('profile_password').'</span>'.'<span class="form-error">'.$sf_request->getError('profile_password_confirm').'</span>'; }?>
