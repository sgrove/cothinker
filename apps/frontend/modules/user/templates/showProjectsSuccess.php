  ...
  <?php if (count($applications) > 0): ?>
    ...
    <?php foreach ($applications as $project): ?>
      <div class="project-listing">
      	<ul class="description">
                      <li class="panels" >
                        <?php // TODO: The "live" directory below should be automagically put in, need to lookup the correct methods for that ?>
                              <?php echo link_to('<img alt="Noproject" src="/live/' . sfConfig::get('sf_web_dir_name'). '/' . sfConfig::get('sf_upload_dir_name') . '/thumbnails/small/noproject.png"/>', '@show_project_application?id='.$project->getUuid()) ?>
                      </li>
      		<li class="panels" style="width:55%;">
