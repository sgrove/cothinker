...
<?php else: ?>
  ...
  <?php if (!$revision->isLatest()): ?>
    <p class="wiki-warning"><?php echo __('You are currently viewing an old revision of this page.') ?> <?php echo link_to(__('Don\'t you want to see the latest version of this page ?'), '@wiki_view?wiki='.$project->getSlug().'&page=' . $page->getName()) ?></p>
  <?php endif ?>
