  ...
  <?php if (@$no_article): ?>
    <p class="wiki-warning">
      ...
      <?php if ($sf_user->isAuthenticated()): ?>
        <?php echo link_to(__('Edit this page to contribute.'), '@wiki_edit?' . $uriParams) ?>
      <?php else: ?>
        <?php echo __('Please login to contribute to this page. You know, so we can tell who deserves the credit!') ?>
      <?php endif; ?>
    </p>
  <?php else: ?>
