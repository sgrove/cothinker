...
Click <a href="<?php echo 'http://'.$this->getContext()->getRequest()->getHost().url_for($url) ?>">here</a> to confirm your email address.<br /><br />

If the above link does not work, you can paste the following address into your browser:<br /><br />

<?php echo 'http://'.$this->getContext()->getRequest()->getHost().url_for($url) ?><br /><br />
