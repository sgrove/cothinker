...
/**
 * Subclass for representing a row from the 'naho_wiki_revision' table.
 *
 * 
 *
 * @package lib.model
 */ 
class nahoWikiRevision extends BasenahoWikiRevision
{
	/**
  ...
  */
  ...
  public function initUserName()
  {
    ...
    if ($user->isAuthenticated()) {
      $this->setUserName($user->getProfile()->getFullName());
    } else {
  ...
  public function getXHTMLContent()
  {
    ...
    $content = nahoWikiContentPeer::preConvert($this->getPage()->getProject()->getSlug(), $this->getPage(), $content);
