...
/**
 * Subclass for representing a row from the 'sf_simple_forum_forum' table.
 *
 * 
 *
 * @package lib.model
...
$xyz = array('from'   => sfSimpleForumForumPeer::NAME, 'to'     => sfSimpleForumForumPeer::STRIPPED_NAME);

sfPropelBehavior::add('sfSimpleForumForum', 
