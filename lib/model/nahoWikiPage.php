...
/**
 * Subclass for representing a row from the 'naho_wiki_page' table.
 *
 * 
 *
 * @package lib.model
 */ 
class nahoWikiPage extends BasenahoWikiPage
{
  ...
  // @todo abstract this so it can be connected to any object, not just projects
  public function getProject()
  {
    if (strtolower($this->getWiki()->getModel()) == 'project') {
      $project = $this->getWiki()->getProject();
      if ($project != null) {
        return $project;
      }
    }
