...
abstract class BasesfSimpleForumTopicViewPeer {
	...
	const CLASS_DEFAULT = 'lib.model.sfSimpleForumTopicView';
	...
	{
		return BasePeer::getMapBuilder('lib.model.map.sfSimpleForumTopicViewMapBuilder');
	}
    ...
    foreach (sfMixer::getCallables('BasesfSimpleForumTopicViewPeer:doSelectRS:doSelectRS') as $callable)
    {
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(sfSimpleForumTopicViewPeer::USER_ID, sfGuardUserPeer::ID);
    ...
    foreach (sfMixer::getCallables('BasesfSimpleForumTopicViewPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BasesfSimpleForumTopicViewPeer', $c, $con);
		...
		$c->addJoin(sfSimpleForumTopicViewPeer::USER_ID, sfGuardUserPeer::ID);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			Propel::registerMapBuilder('lib.model.map.sfSimpleForumTopicViewMapBuilder');
}
