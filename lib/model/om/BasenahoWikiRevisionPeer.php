...
abstract class BasenahoWikiRevisionPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nahoWikiRevision';
	...
	{
		return BasePeer::getMapBuilder('lib.model.map.nahoWikiRevisionMapBuilder');
	}
    ...
    foreach (sfMixer::getCallables('BasenahoWikiRevisionPeer:doSelectRS:doSelectRS') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BasenahoWikiRevisionPeer:doSelectJoin:doSelectJoin') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BasenahoWikiRevisionPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BasenahoWikiRevisionPeer', $c, $con);
    }
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			Propel::registerMapBuilder('lib.model.map.nahoWikiRevisionMapBuilder');
}
