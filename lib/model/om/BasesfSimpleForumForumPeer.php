...
abstract class BasesfSimpleForumForumPeer {
	...
	const CLASS_DEFAULT = 'lib.model.sfSimpleForumForum';
	...
	{
		return BasePeer::getMapBuilder('lib.model.map.sfSimpleForumForumMapBuilder');
	}
    ...
    foreach (sfMixer::getCallables('BasesfSimpleForumForumPeer:doSelectRS:doSelectRS') as $callable)
    {
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			Propel::registerMapBuilder('lib.model.map.sfSimpleForumForumMapBuilder');
}
