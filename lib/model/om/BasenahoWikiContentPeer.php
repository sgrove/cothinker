...
abstract class BasenahoWikiContentPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nahoWikiContent';
	...
	{
		return BasePeer::getMapBuilder('lib.model.map.nahoWikiContentMapBuilder');
	}
    ...
    foreach (sfMixer::getCallables('BasenahoWikiContentPeer:doSelectRS:doSelectRS') as $callable)
    {
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			Propel::registerMapBuilder('lib.model.map.nahoWikiContentMapBuilder');
}
