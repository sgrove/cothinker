...
abstract class BasesfSimpleForumTopicPeer {
	...
	const CLASS_DEFAULT = 'lib.model.sfSimpleForumTopic';
	...
	{
		return BasePeer::getMapBuilder('lib.model.map.sfSimpleForumTopicMapBuilder');
	}
    ...
    foreach (sfMixer::getCallables('BasesfSimpleForumTopicPeer:doSelectRS:doSelectRS') as $callable)
    {
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(sfSimpleForumTopicPeer::USER_ID, sfGuardUserPeer::ID);
    ...
    foreach (sfMixer::getCallables('BasesfSimpleForumTopicPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BasesfSimpleForumTopicPeer', $c, $con);
		...
		$c->addJoin(sfSimpleForumTopicPeer::USER_ID, sfGuardUserPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			Propel::registerMapBuilder('lib.model.map.sfSimpleForumTopicMapBuilder');
}
