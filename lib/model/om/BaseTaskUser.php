...
abstract class BaseTaskUser extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = TaskUserPeer::ID;
		}
	...
	public function setUuid($v)
	{
		...
		if ($this->uuid !== $v) {
			$this->uuid = $v;
			$this->modifiedColumns[] = TaskUserPeer::UUID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = TaskUserPeer::USER_ID;
		}
	...
	public function setTaskId($v)
	{
		...
		if ($this->task_id !== $v) {
			$this->task_id = $v;
			$this->modifiedColumns[] = TaskUserPeer::TASK_ID;
		}
	...
	public function setDeletedAt($v)
	{
		...
		if ($this->deleted_at !== $ts) {
			$this->deleted_at = $ts;
			$this->modifiedColumns[] = TaskUserPeer::DELETED_AT;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== $ts) {
			$this->created_at = $ts;
			$this->modifiedColumns[] = TaskUserPeer::CREATED_AT;
		}
    ...
    foreach (sfMixer::getCallables('BaseTaskUser:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(TaskUserPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseTaskUser:save:post') as $callable)
    {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TaskUserPeer::ID)) $criteria->add(TaskUserPeer::ID, $this->id);
		if ($this->isColumnModified(TaskUserPeer::UUID)) $criteria->add(TaskUserPeer::UUID, $this->uuid);
		if ($this->isColumnModified(TaskUserPeer::USER_ID)) $criteria->add(TaskUserPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(TaskUserPeer::TASK_ID)) $criteria->add(TaskUserPeer::TASK_ID, $this->task_id);
		if ($this->isColumnModified(TaskUserPeer::DELETED_AT)) $criteria->add(TaskUserPeer::DELETED_AT, $this->deleted_at);
		if ($this->isColumnModified(TaskUserPeer::CREATED_AT)) $criteria->add(TaskUserPeer::CREATED_AT, $this->created_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TaskUserPeer::ID, $this->id);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseTaskUser:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseTaskUser::%s', $method));
    }
