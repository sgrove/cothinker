...
abstract class BasesfSimpleForumPostPeer {
	...
	const CLASS_DEFAULT = 'lib.model.sfSimpleForumPost';
	...
	{
		return BasePeer::getMapBuilder('lib.model.map.sfSimpleForumPostMapBuilder');
	}
    ...
    foreach (sfMixer::getCallables('BasesfSimpleForumPostPeer:doSelectRS:doSelectRS') as $callable)
    {
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(sfSimpleForumPostPeer::USER_ID, sfGuardUserPeer::ID);
    ...
    foreach (sfMixer::getCallables('BasesfSimpleForumPostPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BasesfSimpleForumPostPeer', $c, $con);
		...
		$c->addJoin(sfSimpleForumPostPeer::USER_ID, sfGuardUserPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			Propel::registerMapBuilder('lib.model.map.sfSimpleForumPostMapBuilder');
}
