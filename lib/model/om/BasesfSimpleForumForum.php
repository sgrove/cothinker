...
abstract class BasesfSimpleForumForum extends BaseObject  implements Persistent {
	...
	public function getsfSimpleForumPostsJoinsfGuardUser($criteria = null, $con = null)
	{
				include_once 'lib/model/om/BasesfSimpleForumPostPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		...
		if ($this->collsfSimpleForumPosts === null) {
			if ($this->isNew()) {
				...
				$this->collsfSimpleForumPosts = sfSimpleForumPostPeer::doSelectJoinsfGuardUser($criteria, $con);
			}
		} else {
