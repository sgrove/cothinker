...
class ContactCothinkMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.ContactCothinkMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('ct_cothink_contact');
		$tMap->setPhpName('ContactCothink');
