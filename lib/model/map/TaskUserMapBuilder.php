...
class TaskUserMapBuilder {
	...
	const CLASS_NAME = 'lib.model.map.TaskUserMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('ct_task_user');
		...
		$tMap->addForeignKey('TASK_ID', 'TaskId', 'int', CreoleTypes::INTEGER, 'ct_task', 'ID', true, null);
