...
class ProjectUserMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('ct_project_user');
		...
		$tMap->addColumn('UUID', 'Uuid', 'string', CreoleTypes::VARCHAR, true, 8);
		...
		$tMap->addColumn('TOTAL_HOURS', 'TotalHours', 'int', CreoleTypes::INTEGER, false, null);
