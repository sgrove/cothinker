...
/**
 * Subclass for performing query and update operations on the 'naho_wiki_content' table.
 *
 * 
 *
 * @package lib.model
 */ 
class nahoWikiContentPeer extends BasenahoWikiContentPeer
{
  ...
  public static function preConvert($wiki, $page, $content)
  {
    // Convert nahoWiki-specific internal links to a syntax compatible with the chosen wiki engine
    $content = self::convertInternalLinks($wiki, $page, $content);
